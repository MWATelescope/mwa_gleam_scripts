/*  @(#)CALCServer.h  version 1.00  created 99/07/26 10:00:00
    ...
    This version of CALCServer.h taken from DiFX 2.0.1, which includes
    version 9.1 (I think) of CALC. For different versions of calc, you
    may need to update this header
*/
